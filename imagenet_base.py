...
def main():
    ...
    if args.supervised:
        args.identifier = f's_lr_{args.lr}_data_{args.data}'
    else:
        args.identifier = f'ss_lr_{args.lr}_data_{args.data}'
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.supervised:
        ds_train = RetinaMNIST(split='train', download=True, root='./data/')
        ds_val = RetinaMNIST(split='val', download=True, root='./data/')
        ds_test = RetinaMNIST(split='test', download=True, root='./data/')
    ...
    for epoch in range(args.epochs):
        ...
        args.loss_val.append(validate(loader_val, model, criterion, args))
        ...
        with open(f'{args.identifier}.txt', 'w') as f:
            f.write(f'self-supervised learning dataset: {args.data}\n')
